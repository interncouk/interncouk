    ...
    public function run(): void
    {
        ...
        $pages = [
            1 => [
                'name' => 'Homepage',
                'content' =>
                    Html::tag('div', '[search-box subtitle="We have 150,000+ live jobs" title="There Are 98.688 Opportunities Here For you!" highlight_text="Jobcy" description="Find jobs, create trackable resumes and enrich your applications.Carefully crafted after analyzing the needs of different industries." image="general/process-02.png"][/search-box]') .
                    Html::tag('div', '[featured-job-categories title="Browser Jobs Categories" subtitle="Post a job to tell us about your project. We\'ll quickly match you with the right freelancers."][/featured-job-categories]') .
                    Html::tag('div', '[job-tabs title="New & Random Jobs" subtitle="Post a job to tell us about your project. We\'ll quickly match you with the right freelancers."][/job-tabs]') .
                    Html::tag('div', '[how-it-work title="How It Work" subtitle="Post a job to tell us about your project. We\'ll quickly match you with the right freelancers." step_1_title="Register an account" step_1_description="Due to its widespread use as filler text for layouts, non-readability is of great importance." step_1_image="general/how-it-work-1.png" step_2_title="Find your job" step_2_description="There are many variations of passages of avaibookmark-label, but the majority lteration in some form." step_2_image="general/how-it-work-2.png" step_3_title="Apply for job" step_3_description="It is a long established fact that a reader will be distracted by the radable content of a page." step_3_image="general/how-it-work-2.png"][/how-it-work]') .
                    Html::tag('div', '[post-a-job title="Browse Our 5,000+ Latest Jobs" highlight_text="5,000+" subtitle="Post a job to tell us about your project. We\'ll quickly match you with the right freelancers."][/post-a-job]') .
                    Html::tag('div', '[testimonials title="Happy Candidates" subtitle="Post a job to tell us about your project. We\'ll quickly match you with the right freelancers."][/testimonials]') .
                    Html::tag('div', '[featured-news title="Quick Career Tips" subtitle="Post a job to tell us about your project. We\'ll quickly match you with the right freelancers."][/featured-news]') .
            ...
            10 => [
                'name' => 'Job Categories',
                'content' =>
                    Html::tag('div', '[job-categories badge="Jobs Live Today" title="Browse Job By Categories" subtitle="Post a job to tell us about your project. We’ll quickly match you with the right freelancers."][/job-categories]') .
        ...
        $translations = [
            [
                'name' => 'Trang chủ',
                'content' => Html::tag('div', '[search-box subtitle="We have 150,000+ live jobs" title="Find your dream jobs with Jobcy" highlight_text="Jobcy" description="Find jobs, create trackable resumes and enrich your applications.Carefully crafted after analyzing the needs of different industries." image="general/process-02.png"][/search-box]') .
                    Html::tag('div', '[featured-job-categories title="Browser Jobs Categories" subtitle="Post a job to tell us about your project. We\'ll quickly match you with the right freelancers."][/featured-job-categories]') .
                    Html::tag('div', '[job-tabs title="New & Random Jobs" subtitle="Post a job to tell us about your project. We\'ll quickly match you with the right freelancers."][/job-tabs]') .
                    Html::tag('div', '[how-it-work title="How It Work" subtitle="Post a job to tell us about your project. We\'ll quickly match you with the right freelancers." step_1_title="Register an account" step_1_description="Due to its widespread use as filler text for layouts, non-readability is of great importance." step_1_image="general/how-it-work-1.png" step_2_title="Find your job" step_2_description="There are many variations of passages of avaibookmark-label, but the majority lteration in some form." step_2_image="general/how-it-work-2.png" step_3_title="Apply for job" step_3_description="It is a long established fact that a reader will be distracted by the radable content of a page." step_3_image="general/how-it-work-2.png"][/how-it-work]') .
                    Html::tag('div', '[post-a-job title="Browse Our 5,000+ Latest Jobs" highlight_text="5,000+" subtitle="Post a job to tell us about your project. We\'ll quickly match you with the right freelancers."][/post-a-job]') .
