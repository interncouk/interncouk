...
app()->booted(function () {
    ...
    add_shortcode('how-it-work', __('How it work'), __('How it work'), function ($shortcode) {
        return Theme::partial('shortcodes.how-it-work', compact('shortcode'));
    });

    shortcode()->setAdminConfig('how-it-work', function ($attributes) {
        return Theme::partial('shortcodes.how-it-work-admin-config', compact('attributes'));
    });

    add_shortcode('start-working', __('Start working'), __('Start working'), function ($shortcode) {
        return Theme::partial('shortcodes.start-working', compact('shortcode'));
    });

    shortcode()->setAdminConfig('start-working', function ($attributes) {
    ...
    if (is_plugin_active('job-board')) {
        ...
        add_shortcode('job-candidates', __('Candidate list'), __('Candidate list'), function ($shortcode) {
        ...
        add_shortcode('featured-companies', __('Featured companies'), __('Featured companies'), function ($shortcode) {
            ...
            return Theme::partial('shortcodes.featured-companies', compact('shortcode', 'companyIds', 'images'));
        });
        ...
        add_shortcode('post-a-job', __('Post a job'), __('Post a job'), function ($shortcode) {
            return Theme::partial('shortcodes.post-a-job', compact('shortcode'));
        });

        shortcode()->setAdminConfig('post-a-job', function ($attributes) {
